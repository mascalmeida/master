...
public class DCNSFog_LM {
	...
	private static void createFogDevices(int userId, String appId) {
		FogDevice cloud = createFogDevice("cloud", 44800, 40000, 10000, 10000, 0, 0.011, 0, 0);
		cloud.setParentId(-1);
		fogDevices.add(cloud);
		FogDevice proxy = createFogDevice("proxy-server", 1, 4000, 10000, 10000, 1, 0.0, 0, 0);
	...
	private static FogDevice addArea(String id, int userId, String appId, int parentId){
		FogDevice router = createFogDevice("d-"+id, 4000, 4000, 10000, 10000, 1, 0.0, 0, 0);
		fogDevices.add(router);
		router.setUplinkLatency(75); // latency of connection between router and proxy server is 2 ms
		for(int i=0;i<numOfCamerasPerArea;i++){
			...
			camera.setUplinkLatency(4); // latency of connection between camera and router is 2 ms
	...
	private static FogDevice addCamera(String id, int userId, String appId, int parentId){
		FogDevice camera = createFogDevice("m-"+id, 1000, 10000, 10000, 270, 3, 0, 0, 0);
		camera.setParentId(parentId);
		System.out.println(">>>>>>>>>>>>>>>>> SEED BELOW");
	...
	private static Application createApplication(String appId, int userId){
		 ...
		 */
		application.addAppModule("object_detector", 10, 550, 10000);
		application.addAppModule("motion_detector", 10, 300, 10000);
		application.addAppModule("object_tracker", 10, 300, 10000);
		application.addAppModule("user_interface", 10, 200, 10000);
