...
public class AppEdge {
	 ...
	 */
	private Distribution tupleCpuLength;
	/**
	...
	public AppEdge(String source, String destination, Distribution tupleCpuLength,
	...
	public AppEdge(String source, String destination, double periodicity, Distribution tupleCpuLength,
			double tupleNwLength, String tupleType, int direction, int edgeType){
		setSource(source);
		setDestination(destination);
		setTupleCpuLength(tupleCpuLength);
	...
	public Distribution getTupleCpuLength() {
		return tupleCpuLength;
	}
	public void setTupleCpuLength(Distribution tupleCpuLength) {
