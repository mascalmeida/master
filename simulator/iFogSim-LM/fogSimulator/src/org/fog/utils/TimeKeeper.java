...
public class TimeKeeper {
	...
	private Map<Integer, Double> tupleIdCPUExecutionTime;

	public Map<Integer, Tuple> tuplas;
	...
	public void tupleStartedExecution(Tuple tuple){
		...
		tuplas.put(tuple.getCloudletId(), tuple);
	}
	...
	public void tupleEndedExecution(Tuple tuple){
		...
		tupleIdCPUExecutionTime.put(tuple.getCloudletId(), executionTime);
	...
	private TimeKeeper(){
		...
		setTupleIdCPUExecutionTime(new HashMap<>());

		tuplas = new HashMap<>();
	}

	public void setTupleIdCPUExecutionTime(Map<Integer, Double> tupleIdCPUExecutionTime) {
		this.tupleIdCPUExecutionTime = tupleIdCPUExecutionTime;
	}

	public Double getTupleIdCPUExecutionTime(Tuple tuple) {
		return tupleIdCPUExecutionTime.get(tuple.getCloudletId());
	}
	...
	public static class TupleExecution {
		double startTime;
		double endTime;
		String type;
		int deviceLevel;
		...
		public TupleExecution(double startTime, double endTime, String type, int deviceLevel, String deviceName,String module) {
