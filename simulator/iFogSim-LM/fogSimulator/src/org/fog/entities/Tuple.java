...
public class Tuple extends Cloudlet{
	...
	private int associatedModuleInstance;
	...
	public Tuple(String appId, int cloudletId, int direction, long cloudletLength, int pesNumber,
			...
			UtilizationModel utilizationModelBw, int associatedModuleInstance) {
		...
		setAssociatedModuleInstance(associatedModuleInstance);
	}
	...
	public int getAssociatedModuleInstance() { return associatedModuleInstance; }

	public void setAssociatedModuleInstance(int associatedModuleInstance) {
