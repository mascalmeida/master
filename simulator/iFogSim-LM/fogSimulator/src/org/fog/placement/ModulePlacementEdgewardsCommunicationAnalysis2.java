...
public class ModulePlacementEdgewardsCommunicationAnalysis2 extends ModulePlacement{
    ...
    public ModulePlacementEdgewardsCommunicationAnalysis2(List<FogDevice> fogDevices, List<Sensor> sensors, List<Actuator> actuators,
...
//        getFogDeviceById(deviceId).getUplinkLatency()
    ...
    private List<String> shiftModuleWithLessCommunicationImpactNorth(String moduleName, Integer deviceId, List<String> modulesToPlace) {
        ...
        while(true){
            ...
            if(getCurrentDeviceCpuLoad().get(id) + totalCpuLoad > (fogDevice.getHost().getTotalMips()*1.2)){
