...
public class TopologyD extends Topology {
    ...
    private void configNetwork(){
        ...
        Level bottom = top
                ...
                .addNext(new Level(3, new HostConfig(4000, 4000, 10000, 10000,0.0), "cloudlet",25))
                .addNext(new Level(1, new HostConfig(3000, 4000, 10000, 10000,0.0), "cloudlet",25))
